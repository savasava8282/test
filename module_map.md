...
- Прогноз погоды, API-ключ, SQLite, постоянный polling, systemd, расписание и рассылки не добавлены. Реальный запуск нового режима ещё не выполнялся; настоящий токен Codex не читался.
