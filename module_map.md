...
- Единый текущий stop-point: scheduler, forecast, scheduled sending и systemd не начинать; `next_steps.md` отсутствует.

## Актуальная запись реального теста warning categories
