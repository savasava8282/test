...
- Единственный актуальный stop-point: `--wait-for-daily-time` и безопасная миграция существующей SQLite-базы реально подтверждены; следующий функциональный этап не начинался.
