...
- Следующий безопасный шаг только один: контролируемый реальный Telegram + SQLite-тест daily-sending setting. Scheduler, forecast, scheduled sending и systemd не начинать; `next_steps.md` отсутствует.
