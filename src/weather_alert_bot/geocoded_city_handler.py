...
GEOCODING_SUCCESS_PREFIX = "Найден первый подходящий вариант:"
...
def run_until_geocoded_city(
    telegram_client: TelegramClient,
    geocoding_client: OpenMeteoGeocodingClient,
) -> int:
    """Wait for one private city, geocode it, answer, and finish."""
    ...
    try:
        ...
        while True:
            ...
            for update in updates:
                ...
                telegram_client.send_message(
                    chat_id=started_chat_id,
                    text=_format_location(locations[0]),
                )
        ...
        print("Ожидание города с геокодированием остановлено.")
        return 130
